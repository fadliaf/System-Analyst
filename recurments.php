...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="logo" href="#"><img src="images/logo-3.png"></a>
    ...
    <div class="services_section">
        <div class="container">
            <h1 class="services_text">Anggota Kelompok 11</h1>
        </div>
    </div>
    	...
    	<div class="container">
    		<div class="product_section">
    			<div class="row padding_top_0">
    				...
    				<div class="col-sm-8">
    					<h1 class="software_text">M. Hanief Fakhmi A.A</h1>
    					<p class="lorem_ipsum_text">15-2023-056</p>
    				</div>
    				<!-- <div class="col-sm-2">
      ...
      <div class="container">
        <div class="product_section">
          <div class="row padding_top_0">
            ...
            <div class="col-sm-8">
              <h1 class="software_text">Fadli Ahmad F</h1>
              <p class="lorem_ipsum_text">15-2023-047</p>
            </div>
            <!-- <div class="col-sm-2">
              <button class="apply_now">Apply Now</button>
            </div> -->
      ...
      <div class="container">
        <div class="product_section">
          <div class="row padding_top_0">
            ...
            <div class="col-sm-8">
              <h1 class="software_text">Dicky Firmansyah</h1>
              <p class="lorem_ipsum_text">15-2023-067</p>
            </div>
            <!-- <div class="col-sm-2">
              <button class="apply_now">Apply Now</button>
            </div> -->
      ...
      <div class="container">
        <div class="product_section">
          <div class="row padding_top_0">
            ...
            <div class="col-sm-8">
              <h1 class="software_text">Ryan Hapidri Hernowo</h1>
              <p class="lorem_ipsum_text">15-2023-215</p>
            </div>
            <!-- <div class="col-sm-2">
              <button class="apply_now">Apply Now</button>
            </div> -->
    ...
    <div class="copyright_section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <p class="copyright_text">Copyright 2024 All Right Reserved By. Kelompok 11.</p>
          </div>
          <div class="col-md-6">
